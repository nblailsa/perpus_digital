                            ...
                            <div class="card">
                                <div class="row m-4">
                                    ...
                                    <div class="text-center">
                                        <img src="../assets/img/<?php echo $result['gambar']; ?>" width="150" alt="">
                                    </div>
                                    <div class="text-center" style="margin-top: 5rem;">
                                        <h2><b><?php echo $result['judul']; ?></b></h2>
                                        <hr>
                                        <table>
                                            <tr>
                                                <td>
                                        ...
                                        <a href="koleksi.php" class="btn btn-outline-danger">Kembali</a>
                                        <a href="ulasan.php?id_buku=<?php echo $result['id_buku']; ?>" class="btn btn-outline-warning">Berikan Ulasan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
